...
def build_all():
    ...
    samples = [
        ...
        {
            "slug": "scriptorium-localization-ui-pack",
            "title": "Website and App Localization Pack",
            "subtitle": "Original commercial sample for landing pages, app screens and UX microcopy.",
            "cover_title": "Localization UI",
            "cover_subtitle": "Landing page, app copy and SEO notes",
            "code": "UI",
            "metadata": [
                ("Document type", "Original localization and UX writing sample"),
                ("Use", "Websites, apps, e-commerce pages and product onboarding"),
                ("Commercial status", "Quote-only localization work; pricing depends on screens, strings and context"),
                ("Languages", languages),
            ],
            "sections": [
                ("h1", "Project scenario"),
                ("p", "A small digital product needs to adapt its homepage, signup flow and help-center copy for international users. The goal is not literal translation, but a version that feels natural, clear and action-oriented in the target language."),
                ("h1", "Source and localized copy"),
                ("table", ["Component", "English source", "Spanish localization note"], [
                    ["Hero headline", "Manage every document in one calm workspace.", "Gestiona cada documento en un espacio claro y ordenado. Avoids overpromising productivity."],
                    ["CTA", "Start your project", "Iniciar mi proyecto. Keeps action personal and direct."],
                    ["Empty state", "No files yet. Upload your first document to continue.", "Aún no hay archivos. Sube tu primer documento para continuar."],
                    ["Trust note", "Your files remain private until you choose to share them.", "Tus archivos se mantienen privados hasta que decidas compartirlos."],
                    ["Help link", "Need a reviewed translation?", "¿Necesitas una traducción revisada?"],
                ]),
                ("h1", "Localization checklist"),
                ("bullets", [
                    "Confirm product audience, market and tone before translating.",
                    "Separate UI strings, SEO copy and legal/safety text.",
                    "Preserve button length and mobile layout constraints.",
                    "Flag phrases that need cultural adaptation instead of literal rendering.",
                ]),
                ("h1", "Quote variables"),
                ("p", "This type of project is quoted by number of screens, source word count, context availability, SEO requirements and revision depth."),
            ],
        },
        {
            "slug": "scriptorium-brand-transcreation-pack",
            "title": "Brand Voice and Transcreation Pack",
            "subtitle": "Original commercial sample for campaign language, naming and bilingual brand tone.",
            "cover_title": "Brand Voice",
            "cover_subtitle": "Transcreation, naming and bilingual tone",
            "code": "BV",
            "metadata": [
                ("Document type", "Original brand-language and transcreation sample"),
                ("Use", "Campaigns, naming checks, social posts, product copy and brand voice systems"),
                ("Commercial status", "Quote-only; creative language work varies by scope and revision rounds"),
                ("Languages", "Spanish and English base; additional target languages by quote."),
            ],
            "sections": [
                ("h1", "Brand premise"),
                ("p", "A boutique learning platform wants a bilingual tone that feels precise, warm and trustworthy. The brand should avoid generic motivational phrases and instead use language that suggests clarity, discipline and calm progress."),
                ("h1", "Voice principles"),
                ("table", ["Principle", "Use", "Avoid"], [
                    ["Precise", "Short claims with concrete outcomes.", "Vague excellence language."],
                    ["Warm", "Human, direct and respectful wording.", "Overly casual slang."],
                    ["Quietly premium", "Measured confidence and clean structure.", "Luxury cliches or inflated promises."],
                    ["Useful", "Copy that helps the reader decide.", "Decorative phrases without action."],
                ]),
                ("h1", "Transcreation samples"),
                ("table", ["Intent", "English option", "Spanish option"], [
                    ["Primary tagline", "Precision across languages.", "Precisión entre idiomas."],
                    ["CTA", "Send the scope.", "Enviar el alcance."],
                    ["Trust line", "Clear terms before work begins.", "Condiciones claras antes de iniciar."],
                    ["Campaign line", "Make your text travel without losing its voice.", "Haz que tu texto viaje sin perder su voz."],
                ]),
                ("h1", "Quote variables"),
                ("bullets", [
                    "Number of naming or tagline options requested.",
                    "Languages and markets to compare.",
                    "Revision rounds and tone exploration depth.",
                    "Whether the project includes glossary, rationale or presentation deck notes.",
                ]),
            ],
        },
    ]
